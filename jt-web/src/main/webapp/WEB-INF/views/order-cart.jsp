...
<body id="mainframe">
	...
	<form id="orderForm" class="hide">
		...
		<input type="hidden" name="orderShipping.receiverName" value="陈晨" /> <input
			type="hidden" name="orderShipping.receiverMobile" value="13800807944" />
	...
	<div class="w w1 header clearfix">
		<div id="logo">
			<a href="http://www.jt.com/"><img src="/images/jt-logo.png"
				alt="京淘商城" /></a>
		</div>
